        ...
        <Card>
          ...
          <CardContent>
            ...
            <div class="flex items-center gap-2">
                <template v-for="user in group.users.slice(0, group.users.length > MAX_AVATARS ? MAX_AVATARS - 1 : MAX_AVATARS)" :key="user.id">
                    <HoverCard>
                        ...
                        <HoverCardContent class="w-80 rounded-xl">
                            ...
                            <div class="w-full space-y-1">
                                ...
                                <div class="justify-end flex gap-2 items-center">
                    ...
                    <HoverCard>
                        <HoverCardTrigger as-child>
                            <div class="hover:cursor-pointer hover:underline">
                                +{{ group.users.length - (MAX_AVATARS - 1) }}
                            </div>
                        </HoverCardTrigger>
                        <HoverCardContent class="w-80 rounded-xl">
                            <div class="overflow-y-auto pr-2 max-h-60 space-y-4 divide-y">
